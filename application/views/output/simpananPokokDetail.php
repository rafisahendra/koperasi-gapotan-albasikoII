	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"> History Simpanan Pokok</h3>
			...
			<div class="panel-body">
				<table class="table datatable">
					...
					<tbody>
						<?php foreach($detailSimpok as $no => $data): ?>
						<tr>
							<td><?= $no+1 ?></td>
							...
							<!-- <td class="text-center">
								<a href="<?php echo site_url('HomeCtr/anggota_edd/'.$data->id_penyimpanan) ?>"
									...
									href="<?php echo site_url('HomeCtr/simpokok_del/'.$data->id_penyimpanan.'/'.$data->id_anggota.'/'.$data->id_kategori) ?>"	class="btn btn-small text-danger"><i class="fa fa-trash-o"></i> Hapus</a>
